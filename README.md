...
It does not pretend to replace the Church, the sacraments, confession, parish life, or a real spiritual father. It is a small Christian cell for people who feel the spiritual hunger for monk life: silence, repentance, simplicity, unceasing prayer, and union with Christ.
...
- Repeated Paschal Thread boxes in major chambers so Witness, Scripture, Creed, Prayer, Body Temple, Examen, and Departure all return to the Cross and Resurrection.
...
- Private Paschal Examen inside the rule flow asks what must be crucified, what Christ is raising, what repair is needed, and where mercy was received.
...
- Evening Examen / Confession Prep mode with private local saving to `data/examen.jsonl`.
...
- Purity chamber for fighting lust and fleshly habit with custody of the eyes, bodily action, watchfulness, repentance without despair, confession, and brotherhood.
